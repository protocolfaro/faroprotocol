...
out = str(_REPORT_DIR / 'faro_reporte_velez_piletas.png')
plt.savefig(out, dpi=DPI, facecolor=BG, bbox_inches='tight', pad_inches=0.08)
plt.close()
print(f'Saved: {out}')

_desktop = pathlib.Path.home() / 'Desktop' / 'faro_reporte_velez_piletas.png'
shutil.copy2(out, str(_desktop))
print(f'Desktop: {_desktop}')
