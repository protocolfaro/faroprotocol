"""
gen_velez_poli.py
Faro Protocol - Reporte Polideportivo Feijoo - Velez Sarsfield
"""
import matplotlib
matplotlib.use('Agg')
...
TITULO     = 'Polideportivo Feijóo'
SECTOR_KEY = 'poli'
OUT_NAME   = 'faro_reporte_velez_poli.png'

now   = datetime.now()
FECHA = now.strftime('%d/%m/%Y')
CERT  = hashlib.sha256(f"FARO-VLZ-POLI-{now.isoformat()}".encode()).hexdigest()[:20].upper()
