...
Faro Protocol - Reporte Complejo Acuatico - Velez Sarsfield
"""
import matplotlib
matplotlib.use('Agg')
...
TITULO     = 'Complejo Acuático'
SECTOR_KEY = 'piletas'
OUT_NAME   = 'faro_reporte_velez_piletas.png'

now   = datetime.now()
FECHA = now.strftime('%d/%m/%Y')
CERT  = hashlib.sha256(f"FARO-VLZ-PILETAS-{now.isoformat()}".encode()).hexdigest()[:20].upper()
