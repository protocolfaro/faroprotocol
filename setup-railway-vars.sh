...
echo "  RAILWAY_URL"
echo "  RESEND_API_KEY     (mismo valor que Railway RESEND_API_KEY)"
echo "  RESEND_FROM        (mismo valor que Railway RESEND_FROM)"
echo "  PANELES_DEPLOY_TOKEN  (token PAT con repo scope para protocolfaro/faro-paneles)"
echo ""
